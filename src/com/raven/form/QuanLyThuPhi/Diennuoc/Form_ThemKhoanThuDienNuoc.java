...
public class Form_ThemKhoanThuDienNuoc extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        searchText_GhiChu.setText("Không");
    ...
    private void jButton_XacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_XacNhanActionPerformed
        // TODO add your handling code here:
         if(searchText_TenKhoanThu.getText().isEmpty() || searchText_GhiChu.getText().isEmpty() ){
                         JOptionPane.showMessageDialog(null,"Hãy nhập đủ các thông tin yêu cầu"); return;
                     }
                     myKT.setTen_KThu(searchText_TenKhoanThu.getText()); 
                     myKT.setLoai_KThu(jComboBox_Loai.getSelectedItem().toString());
                     myKT.setGhi_chu(searchText_GhiChu.getText());                     
